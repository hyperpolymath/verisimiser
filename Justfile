...
doctor:
    @echo "Running diagnostics for verisimiser..."
...
heal:
    @echo "Attempting auto-repair for verisimiser..."
...
help-me:
    @echo "=== verisimiser Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/verisimiser/issues/new"
    @echo ""
