...
// Replace verisimiser, Verisimiser — See README.adoc for details., just run, Verisimiser started successfully. with actuals
= verisimiser — Quick Start for Users
:toc:
:toclevels: 2

== What is verisimiser?

Verisimiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./verisimiser-portable
----
...
[source]
----
Verisimiser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/verisimiser/wiki
